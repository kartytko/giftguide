...
data class ItemDetails(val id: String? = null, val displayName: String, val category: String, val price: Price, val redirectUrl: String? = null, val photoUrl: String? = null, val postgresId: Long = -1)
